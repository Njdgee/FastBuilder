...
//Credit: https://github.com/diamond-rip/Eden/blob/master/src/main/java/rip/diamond/practice/util/CC.java
...
public class CC {
    ...
    public static ChatColor getColorFromStr(String str) {
        str = str.replace("&", "").replace("§", "");

        for (ChatColor color : ChatColor.values()) {
            if (str.contains(String.valueOf(color.getChar()))) {
                return color;
            }
        }
